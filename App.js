...
import { VersionCheckProvider, useVersionCheckContext } from './context/VersionCheckContext';
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <Provider store={store}>
        <VersionCheckProvider>
          ...
          <NavigationContainer>
            <Stack.Navigator screenOptions={{ headerShown: Platform.OS == 'android' ? false : false, headerBackButtonMenuEnabled: false, headerBackTitle: 'بازگشت', headerTitleStyle: NewStyles.text10, headerTintColor: themeColor1.bgColor(1), headerStyle: { backgroundColor: themeColor1.bgColor(1), elevation: 0 }, headerShadowVisible: false }} >

              <Stack.Screen name='Landing' component={Landing} options={{ gestureEnabled: false }} />
              <Stack.Screen name='MainLayout' component={MainLayout} options={{ gestureEnabled: false }} />
