    ...
    const wallets = [
        {
            ...
            text5: 'تبدیل',
            action5: () => { accessToken ? navigation.navigate('GoldConvert') : navigation.navigate('MainLayout', { screen: 'Account' }) }
        },
        {
            id: '3',
            title: 'کیف پول نقره',
            ...
            text5: 'تبدیل',
            action5: () => { accessToken ? navigation.navigate('SilverConvert') : navigation.navigate('MainLayout', { screen: 'Account' }) }
        },
        {
            id: '2',
            title: 'کیف پول ریالی',
