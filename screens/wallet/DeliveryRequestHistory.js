...
export default function DeliveryRequestHistory({ navigation }) {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${uri}/delivery/history/`, { headers: { 'Accept': 'application/json', 'Authorization': `Bearer ${accessToken}` } })
