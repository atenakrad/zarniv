...
export default function SellSilverRequestHistory({ navigation }) {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${uri}/sell/silver/history/`, { headers: { 'Accept': 'application/json', 'Authorization': `Bearer ${accessToken}` } })
